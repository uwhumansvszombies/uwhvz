# Generated by Django 2.0 on 2018-01-10 20:03
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(error_messages={'unique': 'An account with that username already exists.'}, help_text='You need a username so we can identify you. Must be 150 characters or fewer, containing any of letters, numbers, periods (.), dashes (-), or underscores (_).', max_length=150, unique=True, validators=[app.accounts.user_validator.UsernameValidator()])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', enumfields.fields.EnumField(enum=app.models.player.Role, max_length=1)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('modified_at', models.DateTimeField(auto_now=True)),
